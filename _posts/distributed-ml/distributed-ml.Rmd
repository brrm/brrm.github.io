...
<figcaption aria-hidden="true">Four rank broadcast</figcaption>
</figure>
...
We can use pipelining to do even better: we split the tensor into chunks, with the $i^\text{th}$ rank at the start (or **root**) of the ring corresponding to the $i^\text{th}$ chunk.
