...
effect estimation. It also includes a light introduction to boosting and
...
<figcaption>Example fit of Rzepakowski and Jaroszewicz’ decision
tree</figcaption>
</figure>
...
learning objective
($\ref{eq:adaobjective}$) is analogous to maximising accuracy under
...
$$\begin{align}
    ...
    &= \mathrm{argmin}_{\alpha \in \mathbb R^+} \sum_{i=1}^N \exp(-y_i H_t(\mathbf x_i)) \exp(\alpha h(\mathbf x_i)) \nonumber\\ 
...
::: thebibliography
10 Gutierrez, P., & Gérardy, J. Causal Inference and Uplift Modelling: A
Review of the Literature. International Conference on Predictive APIs
and Apps (2017). D. B. Rubin. Estimating causal effects of treatments in
randomized and nonrandomized studies. Journal of Educational Psychology,
66(5):688 (1974). Rzepakowski, P., & Jaroszewicz, S. Decision trees for
uplift modeling with single and multiple treatments. Knowl Inf Syst 32,
303--327 (2012). Freund, Y., & Schapire R. A Decision-Theoretic
Generalization of On-Line Learning and an Application to Boosting.
Journal of Computer and System Sciences, Volume 55, Issue 1 (1997).
Schapire, R., Singer, Y. Improved Boosting Algorithms Using
